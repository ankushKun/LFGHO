...
export default function Title() {
  ...
  return (
    <div className="w-full h-[35rem] box-border	 bg-slate-600">
    <div className="flex flex-row justify-around pt-20 pl-14">
      <div className="w-2/5 h-[30rem] 	">   {/*border-solid border-black	border-4*/ }
        ...
        <h2 className="text-3xl pt-8	">
          Elevating Trust in the Blockchain with Karma Vouch - Where DAO Members
          Validate Genuine Identities
        </h2>
      </div>
      <div className="w-2/5	h-[30rem] flex flex-col justify-center items-center gap-7"> {/*border-solid border-black	border-4*/ }
